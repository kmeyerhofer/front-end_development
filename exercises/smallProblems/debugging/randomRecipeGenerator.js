...
var dishName = Array.concat(random(adjective), random(firstNoun), random(secondNoun));
var dish = Array.concat(random(ingredients, 3), random(spices, 2), random(extras, 1));

...
function extend(obj, mixinObj) {
  // var prevProto = Object.getPrototypeOf(obj);
  // obj.__proto__ = mixinObj.__proto__;
  // mixinObj.__proto__ = prevProto;
  // return obj;
  var methodNames = Object.keys(mixinObj);
  methodNames.forEach(function(name) {
    obj[name] = delegate(obj, mixinObj, name);
  });
  return obj;
}
...
var professional = {
  invoice: function() {
    console.log(this.fullname() + ' is billing the customer.');
  },
  payTax: function() {
